...
{
    public class UserTestController : BaseRoController<IUserTestRoService, UserTest, Guid, UserTestDto, UserTestDto>
    {
        public UserTestController([NotNull] IUserTestRoService crudRoService,
